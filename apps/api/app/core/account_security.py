...
def _ensure_postgres_auth_tables(cursor: Any) -> None:
    ...
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_evt_user_id ON email_verification_tokens (user_id)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_evt_token_hash ON email_verification_tokens (token_hash)")
    cursor.execute(
        """
    ...
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_prt_user_id ON password_reset_tokens (user_id)")
    cursor.execute("CREATE INDEX IF NOT EXISTS idx_prt_reset_code_hash ON password_reset_tokens (reset_code_hash)")
    cursor.execute(
        """
